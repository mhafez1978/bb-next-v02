        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-2/3 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              {/* <img
                ...
                /> */}
              <div className="mb-6 inline-block w-[380px] font-extrabold">
                <a href="/" className="text-xl lg:text-2xl text-white">
                  Blooming Brands
                </a>
              </div>
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              <a href="#" className="mb-8 flex items-center text-white ">
          ...
          <div className="-mx-4 flex flex-wrap">
            ...
            <div className="w-full px-4 md:w-1/3 lg:w-1/2">
              <div className="my-1 flex justify-center md:justify-end">
                <p className="text-base text-white">
                  &copy; {new Date().getFullYear()} Blooming Brands
                </p>
              </div>
            </div>
          </div>
...
const NavLink = ({ label, link }: { label: string; link: string }) => {
  return (
    <li>
      <a
        href={link}
        className="inline-block text-base leading-loose text-white underline-offset-2  hover:underline"
      >
        {label}
      </a>
    </li>
...
const BottomNavLink = ({ label, link }: { label: string; link: string }) => {
  return (
    <a
      href={link}
      className="px-3 text-base text-white underline-offset-2  hover:underline"
    >
      {label}
    </a>
  );
